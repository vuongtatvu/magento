...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $setup->getConnection()->newTable($setup->getTable('magenest_brand_product'))->addColumn(
            ...
            $setup->getIdxName('magenest_brand_product', ['product_id']),
            ['product_id']
        )->addForeignKey(
            $setup->getFkName(
        ...
        $table = $setup->getConnection()->newTable($setup->getTable('magenest_brand_store'))->addColumn(
            ...
            $setup->getIdxName('magenest_brand_store', ['store_id']),
            ['store_id']
        )->addForeignKey(
        ...
        // When setup:upgrade new version ! Please comment * Add Url Rewrite
        ...
        foreach ($collection as $store) {
            $this->_urlRewrite->setData(
                [
                 'url_rewrite_id' => null,
                 'entity_type'    => 'brand',
                 'entity_id'      => '0',
                 'request_path'   => Router::ROUTER_BRAND,
