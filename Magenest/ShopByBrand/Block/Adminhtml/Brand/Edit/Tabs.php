    ...
    protected function _prepareLayout()
    {
        $this->addTab(
            ...
            'content' => $this->getLayout()->createBlock(
                'Magenest\ShopByBrand\Block\Adminhtml\Brand\Edit\Tab\Main',
                'brand.tab.main'
            )->toHtml(),
            ]
        );
        $this->addTab(
            ...
            [
             'label'   => __('Images'),
            'content' => $this->getLayout()->createBlock(
                'Magenest\ShopByBrand\Block\Adminhtml\Brand\Edit\Tab\Images',
                'brand.tab.images'
            )->toHtml(),
            ]
        );
        ...
        $this->addTab(
            ...
            [
             'label'   => __('Brand Page'),
            'content' => $this->getLayout()->createBlock(
                'Magenest\ShopByBrand\Block\Adminhtml\Brand\Edit\Tab\BrandPage',
                'brand.tab.brand'
            )->toHtml(),
            ]
        );
