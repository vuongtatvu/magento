...
class Create extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($_POST) {
            ...
            $movieCollection = $this->_objectManager->create('Magenest\Movie\Model\MagenestMovie');
            ...
            $this->messageManager->addSuccess(__('You create movie success.'));

            //Observer
//            $this->_eventManager->dispatch('change_rating', ['change' => $movieCollection]);
